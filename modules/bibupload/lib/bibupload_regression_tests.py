    ...
    def test_simple_fft_insert(self):
        ...
        <controlfield tag="003">SzGeCERN</controlfield>
         ...
         <datafield tag="856" ind1="4" ind2=" ">
          <subfield code="u">%(siteurl)s/%(CFG_RECORD_URI)s/123456789/files/site_logo.gif</subfield>
         </datafield>
        </record>
        """ % {'siteurl': CFG_SITE_URL, 'CFG_RECORD_URI': CFG_RECORD_URI}
        testrec_expected_hm = """
        001__ 123456789
        003__ SzGeCERN
        100__ $$aTest, John$$uTest University
        8564_ $$u%(siteurl)s/%(CFG_RECORD_URI)s/123456789/files/site_logo.gif
        """ % {'siteurl': CFG_SITE_URL, 'CFG_RECORD_URI': CFG_RECORD_URI}
        testrec_expected_url = "%(siteurl)s/%(CFG_RECORD_URI)s/123456789/files/site_logo.gif" \
            % {'siteurl': CFG_SITE_URL, 'CFG_RECORD_URI': CFG_RECORD_URI}
        # insert test record:
        recs = bibupload.xml_marc_to_records(test_to_upload)
        err, recid = bibupload.bibupload(recs[0], opt_mode='insert')
...
allow any</subfield>
    ...
    def test_exotic_format_fft_append(self):
        ...
        <controlfield tag="003">SzGeCERN</controlfield>
         ...
         <datafield tag="856" ind1="4" ind2=" ">
          <subfield code="u">%(siteurl)s/%(CFG_RECORD_URI)s/123456789/files/test.ps.Z</subfield>
         </datafield>
        </record>
        """ % {'siteurl': CFG_SITE_URL,
        ...
        8564_ $$u%(siteurl)s/%(CFG_RECORD_URI)s/123456789/files/test.ps.Z
        """ % {'siteurl': CFG_SITE_URL,
            'CFG_RECORD_URI': CFG_RECORD_URI,
            'email_tag': email_tag,
            ...
            'email_code': email_code}
        testrec_expected_url = "%(siteurl)s/%(CFG_RECORD_URI)s/123456789/files/test.ps.Z" \
               % {'siteurl': CFG_SITE_URL, 'CFG_RECORD_URI': CFG_RECORD_URI}
        testrec_expected_url2 = "%(siteurl)s/%(CFG_RECORD_URI)s/123456789/files/test?format=ps.Z" \
               % {'siteurl': CFG_SITE_URL, 'CFG_RECORD_URI': CFG_RECORD_URI}
        # insert test record:
        recs = bibupload.xml_marc_to_records(test_to_upload)
        err, recid = bibupload.bibupload(recs[0], opt_mode='insert')
    ...
    def test_detailed_fft_insert(self):
        ...
        <controlfield tag="003">SzGeCERN</controlfield>
         ...
         <datafield tag="856" ind1="4" ind2=" ">
          <subfield code="u">%(siteurl)s/%(CFG_RECORD_URI)s/123456789/files/CIDIESSE.gif</subfield>
          <subfield code="y">This is a description</subfield>
          <subfield code="z">This is a comment</subfield>
         </datafield>
         <datafield tag="856" ind1="4" ind2=" ">
          <subfield code="u">%(siteurl)s/%(CFG_RECORD_URI)s/123456789/files/CIDIESSE.jpeg</subfield>
          <subfield code="y">This is a description</subfield>
          <subfield code="z">This is a second comment</subfield>
         </datafield>
        </record>
        ...
        003__ SzGeCERN
        100__ $$aTest, John$$uTest University
        8564_ $$u%(siteurl)s/%(CFG_RECORD_URI)s/123456789/files/CIDIESSE.gif$$yThis is a description$$zThis is a comment
        8564_ $$u%(siteurl)s/%(CFG_RECORD_URI)s/123456789/files/CIDIESSE.jpeg$$yThis is a description$$zThis is a second comment
        """ % {'siteurl': CFG_SITE_URL, 'CFG_RECORD_URI': CFG_RECORD_URI}
        testrec_expected_url1 = "%(siteurl)s/%(CFG_RECORD_URI)s/123456789/files/CIDIESSE.gif" % {'siteurl': CFG_SITE_URL, 'CFG_RECORD_URI': CFG_RECORD_URI}
        testrec_expected_url2 = "%(siteurl)s/%(CFG_RECORD_URI)s/123456789/files/CIDIESSE.jpeg" % {'siteurl': CFG_SITE_URL, 'CFG_RECORD_URI': CFG_RECORD_URI}
        # insert test record:
        recs = bibupload.xml_marc_to_records(test_to_upload)
        err, recid = bibupload.bibupload(recs[0], opt_mode='insert')
        # replace test buffers with real recid of inserted test record:
    ...
    def test_simple_fft_insert_with_restriction(self):
        ...
        <controlfield tag="003">SzGeCERN</controlfield>
         ...
         <datafield tag="856" ind1="4" ind2=" ">
          <subfield code="u">%(siteurl)s/%(CFG_RECORD_URI)s/123456789/files/site_logo.gif?subformat=icon</subfield>
        ...
        %(email_tag)s%(email_ind1)s%(email_ind2)s $$%(email_code)sjekyll@cds.cern.ch
        8564_ $$u%(siteurl)s/%(CFG_RECORD_URI)s/123456789/files/site_logo.gif
        8564_ $$u%(siteurl)s/%(CFG_RECORD_URI)s/123456789/files/site_logo.gif?subformat=icon$$xicon
        980__ $$aARTICLE
        """ % {'siteurl': CFG_SITE_URL,
            'CFG_RECORD_URI': CFG_RECORD_URI,
            'email_tag': email_tag,
        ...
        testrec_expected_url = "%(siteurl)s/%(CFG_RECORD_URI)s/123456789/files/site_logo.gif" \
            % {'siteurl': CFG_SITE_URL, 'CFG_RECORD_URI': CFG_RECORD_URI}
        testrec_expected_icon = "%(siteurl)s/%(CFG_RECORD_URI)s/123456789/files/site_logo.gif?subformat=icon" \
            % {'siteurl': CFG_SITE_URL, 'CFG_RECORD_URI': CFG_RECORD_URI}
        # insert test record:
        recs = bibupload.xml_marc_to_records(test_to_upload)
        err, recid = bibupload.bibupload(recs[0], opt_mode='insert')
    ...
    def test_multiple_fft_insert(self):
        ...
        <controlfield tag="003">SzGeCERN</controlfield>
         ...
         <datafield tag="FFT" ind1=" " ind2=" ">
          <subfield code="a">%(siteurl)s/%(CFG_RECORD_URI)s/95/files/9809057.pdf</subfield>
         </datafield>
         <datafield tag="FFT" ind1=" " ind2=" ">
        ...
        <controlfield tag="003">SzGeCERN</controlfield>
         ...
         <datafield tag="856" ind1="4" ind2=" ">
          <subfield code="u">%(siteurl)s/%(CFG_RECORD_URI)s/123456789/files/9809057.pdf</subfield>
         </datafield>
         <datafield tag="856" ind1="4" ind2=" ">
          <subfield code="u">%(siteurl)s/%(CFG_RECORD_URI)s/123456789/files/demobibdata.xml</subfield>
         </datafield>
         <datafield tag="856" ind1="4" ind2=" ">
          <subfield code="u">%(siteurl)s/%(CFG_RECORD_URI)s/123456789/files/head.gif</subfield>
         </datafield>
         <datafield tag="856" ind1="4" ind2=" ">
          <subfield code="u">%(siteurl)s/%(CFG_RECORD_URI)s/123456789/files/site_logo.gif</subfield>
         </datafield>
        ...
        003__ SzGeCERN
        100__ $$aTest, John$$uTest University
        8564_ $$u%(siteurl)s/%(CFG_RECORD_URI)s/123456789/files/9809057.pdf
        8564_ $$u%(siteurl)s/%(CFG_RECORD_URI)s/123456789/files/demobibdata.xml
        8564_ $$u%(siteurl)s/%(CFG_RECORD_URI)s/123456789/files/head.gif
        8564_ $$u%(siteurl)s/%(CFG_RECORD_URI)s/123456789/files/site_logo.gif
        """ % { 'siteurl': CFG_SITE_URL, 'CFG_RECORD_URI': CFG_RECORD_URI}
        # insert test record:
        testrec_expected_urls = []
        for files in ('site_logo.gif', 'head.gif', '9809057.pdf', 'demobibdata.xml'):
            testrec_expected_urls.append('%(siteurl)s/%(CFG_RECORD_URI)s/123456789/files/%(files)s' % {'siteurl' : CFG_SITE_URL, 'CFG_RECORD_URI': CFG_RECORD_URI, 'files' : files})
        recs = bibupload.xml_marc_to_records(test_to_upload)
        err, recid = bibupload.bibupload(recs[0], opt_mode='insert')
        # replace test buffers with real recid of inserted test record:
        testrec_expected_xm = testrec_expected_xm.replace('123456789',
        ...
        testrec_expected_urls = []
        for files in ('site_logo.gif', 'head.gif', '9809057.pdf', 'demobibdata.xml'):
            testrec_expected_urls.append('%(siteurl)s/%(CFG_RECORD_URI)s/%(recid)s/files/%(files)s' % {'siteurl' : CFG_SITE_URL, 'CFG_RECORD_URI': CFG_RECORD_URI, 'files' : files, 'recid' : recid})
        # compare expected results:
        inserted_xm = print_record(recid, 'xm')
        inserted_hm = print_record(recid, 'hm')
    ...
    def test_fft_vs_bibedit(self):
        ...
        8564_ $$u%(siteurl)s/%(CFG_RECORD_URI)s/123456789/files/site_logo.gif$$x01$$yBibEdit Description$$zBibEdit Comment
        8564_ $$uhttp://cern.ch/
        """ % { 'siteurl': CFG_SITE_URL, 'CFG_RECORD_URI': CFG_RECORD_URI}
        testrec_expected_url = "%(siteurl)s/%(CFG_RECORD_URI)s/123456789/files/site_logo.gif" \
            % {'siteurl': CFG_SITE_URL, 'CFG_RECORD_URI': CFG_RECORD_URI}
    ...
    def test_detailed_fft_correct(self):
        ...
        <controlfield tag="003">SzGeCERN</controlfield>
         ...
         <datafield tag="856" ind1="4" ind2=" ">
          <subfield code="u">%(siteurl)s/%(CFG_RECORD_URI)s/123456789/files/patata.gif</subfield>
        ...
        003__ SzGeCERN
        100__ $$aTest, John$$uTest University
        8564_ $$u%(siteurl)s/%(CFG_RECORD_URI)s/123456789/files/patata.gif$$yNext Try$$zComment
        """ % { 'siteurl': CFG_SITE_URL, 'CFG_RECORD_URI': CFG_RECORD_URI}
        testrec_expected_url = "%(siteurl)s/%(CFG_RECORD_URI)s/123456789/files/patata.gif" \
            % {'siteurl': CFG_SITE_URL, 'CFG_RECORD_URI': CFG_RECORD_URI}
    ...
    def test_no_url_fft_correct(self):
        ...
        003__ SzGeCERN
        100__ $$aTest, John$$uTest University
        8564_ $$u%(siteurl)s/%(CFG_RECORD_URI)s/123456789/files/patata.gif$$yTry$$zNext Comment
        """ % { 'siteurl': CFG_SITE_URL, 'CFG_RECORD_URI': CFG_RECORD_URI}
        testrec_expected_url = "%(siteurl)s/%(CFG_RECORD_URI)s/123456789/files/patata.gif" \
            % {'siteurl': CFG_SITE_URL, 'CFG_RECORD_URI': CFG_RECORD_URI}
    ...
    def test_new_icon_fft_append(self):
        ...
        8564_ $$u%(siteurl)s/%(CFG_RECORD_URI)s/123456789/files/site_logo.gif?subformat=icon$$xicon
        """ % { 'siteurl': CFG_SITE_URL, 'CFG_RECORD_URI': CFG_RECORD_URI}
        testrec_expected_url = "%(siteurl)s/%(CFG_RECORD_URI)s/123456789/files/site_logo.gif?subformat=icon" \
            % {'siteurl': CFG_SITE_URL, 'CFG_RECORD_URI': CFG_RECORD_URI}
    ...
    def test_multiple_fft_correct(self):
        ...
        003__ SzGeCERN
        100__ $$aTest, John$$uTest University
        8564_ $$u%(siteurl)s/%(CFG_RECORD_URI)s/123456789/files/patata.gif
        """ % { 'siteurl': CFG_SITE_URL, 'CFG_RECORD_URI': CFG_RECORD_URI}
        testrec_expected_url = "%(siteurl)s/%(CFG_RECORD_URI)s/123456789/files/patata.gif" \
            % {'siteurl': CFG_SITE_URL, 'CFG_RECORD_URI': CFG_RECORD_URI}
    ...
    def test_purge_fft_correct(self):
        ...
        8564_ $$u%(siteurl)s/%(CFG_RECORD_URI)s/123456789/files/site_logo.gif
        """ % { 'siteurl': CFG_SITE_URL, 'CFG_RECORD_URI': CFG_RECORD_URI}
        testrec_expected_url = "%(siteurl)s/%(CFG_RECORD_URI)s/123456789/files/site_logo.gif" % { 'siteurl': CFG_SITE_URL, 'CFG_RECORD_URI': CFG_RECORD_URI}
    ...
    def test_revert_fft_correct(self):
        ...
        self.assertEqual(test_web_page_content('%s/%s/%s/files/site_logo.gif?version=1' % (CFG_SITE_URL, CFG_RECORD_URI, recid), 'jekyll', 'j123ekyll', expected_content_version1), [])
        self.assertEqual(test_web_page_content('%s/%s/%s/files/site_logo.gif?version=2' % (CFG_SITE_URL, CFG_RECORD_URI, recid), 'jekyll', 'j123ekyll', expected_content_version2), [])
        self.assertEqual(test_web_page_content('%s/%s/%s/files/site_logo.gif?version=3' % (CFG_SITE_URL, CFG_RECORD_URI, recid), 'jekyll', 'j123ekyll', expected_content_version3), [])
    ...
    def test_simple_fft_replace(self):
        ...
        """ % {
            ...
            'email_ind2': email_ind2 == ' ' and '_' or email_ind2,
            'email_code': email_code}
        testrec_expected_url = "%(siteurl)s/%(CFG_RECORD_URI)s/123456789/files/head.gif" % { 'siteurl': CFG_SITE_URL, 'CFG_RECORD_URI': CFG_RECORD_URI}
